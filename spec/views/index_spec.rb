...
RSpec.describe 'Users', type: :system do
  describe 'index' do
    before(:each) do
      User.create(name: 'Test', email: 'a@a', photo: 'https://unsplash.com/photos/F_-0BxGuVvo',
                  password: '123456', posts_counter: 3, confirmed_at: Time.now)
      User.create(name: 'Test2', email: 'b@b', photo: 'https://unsplash.com/photos/F_-0BxGuVvo',
